...
public class Sms_create extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_view_sms = findViewById(R.id.btn_view_sms);
        ...
        tts = new TextToSpeech(getApplicationContext(), new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int i) {
                if(i==TextToSpeech.SUCCESS){
                    ...
                    tts.speak("Welcome to SMS section, please enter the number and your message.",TextToSpeech.QUEUE_ADD,null);
                }
        ...
        btn_send.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                int permissionCheck = ContextCompat.checkSelfPermission(Sms_create.this, Manifest.permission.SEND_SMS);

                if(permissionCheck == PackageManager.PERMISSION_GRANTED){
                    MyMessage();
                }
                else{
                    ActivityCompat.requestPermissions(Sms_create.this,new String[] {Manifest.permission.SEND_SMS},0);
                }
                return false;
            }
        });
        ...
        switch (keycode) {
            case KeyEvent.KEYCODE_VOLUME_UP:
                if(KeyEvent.ACTION_UP==action)
                {
                    ...
                    intent.putExtra(RecognizerIntent.EXTRA_LANGUAGE,
                            Locale.getDefault());
                    intent.putExtra(RecognizerIntent.EXTRA_PROMPT, "Tell you phone number slowly");
                    try {
            ...
            case KeyEvent.KEYCODE_VOLUME_DOWN:
                if(KeyEvent.ACTION_DOWN==action)
                {
                    ...
                    intent.putExtra(RecognizerIntent.EXTRA_LANGUAGE,
                            Locale.getDefault());
                    intent.putExtra(RecognizerIntent.EXTRA_PROMPT, "Hi speak your message");
                    try {
        ...
        switch (requestCode) {
            ...
            case 2:
                if (resultCode == RESULT_OK && null != data) {
                    Toast.makeText(getApplicationContext(), "Hello",Toast.LENGTH_SHORT);
                    ArrayList<String> result = data.getStringArrayListExtra(RecognizerIntent.EXTRA_RESULTS);
                    txt_pNumber.setText(result.get(0));
                }
                break;
        }
    }
